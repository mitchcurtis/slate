...
{
    QTEST_CHECKED(createNewTilesetProject(32, 32, 5, 5));
    ...
    // Draw a tile on.
    QTEST_CHECKED(switchMode(TileCanvas::TileMode));
    ...
    QTEST_CHECKED(switchMode(TileCanvas::PixelMode));
    setCursorPosInScenePixels(10, 10);
    QTest::mouseClick(window, Qt::LeftButton, Qt::NoModifier, cursorWindowPos);
    QTEST_CHECKED(compareImages(*tilesetProject->tileset()->image(), expectedTilesetImage));
